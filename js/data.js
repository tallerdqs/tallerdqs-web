...
const PROJECTS_RAW = [
  { id:'casa-arboledas', name:'Casas Arboledas', type:'Residencial', location:'Santiago, N.L.', year:'2026', client:'Privado', area:'295 m²', status:'En construcción', planes:3,
  ...
  { id:'casa-el-uro', name:'Casa El Uro', type:'Residencial', location:'Monterrey, N.L.', year:'2023', client:'Privado', area:'520 m²', status:'Construido', planes:3,
  ...
  { id:'casa-mm', name:'Casa MM', type:'Residencial', location:'Santa Catarina, N.L.', year:'2026', client:'Privado', area:'320 m²', status:'En etapa de diseño', planes:4,
  ...
  { id:'depto-pixel', name:'Depto Pixel', type:'Residencial', location:'Monterrey, N.L.', year:'2026', client:'Privado', area:'180 m²', status:'En construcción', planes:0,
    ...
    tagline:'Un departamento neutro donde cada metro trabaja a favor de quien lo vive.',
    longDesc:'Proyecto de diseño de interiores para un departamento en la ciudad de Monterrey, enfocado en la optimización del espacio y en la experiencia del día a día.',
  ...
  { id:'cafe-breno', name:'Cafe Breno', type:'Comercial', location:'CDMX', year:'2022', client:'Privado', area:'24 m²', status:'Construido', planes:2,
    portada:'foto1-FACHADA.jpg',
    fotos:['foto1-FACHADA.jpg','foto2-FACHADA ARCO ROJO.jpg','foto3-FACHADA LOCAL AMPLIO.jpg','foto4-FACHADA VANO RECTO.jpg','foto5-FACHADA MADERA OSCURA.jpg'],
    planosFiles:['plano1-MODULOS.jpg','plano2-EJEMPLOS DE ACOMODO.jpg'],
    tagline:'Un esquema modular que traslada la identidad de la marca a cualquier local.',
  ...
  { id:'cafeteria-olor', name:'Cafeteria Olor', type:'Comercial', location:'Chicago, IL', year:'2021', client:'Privado', area:'94 m²', status:'En etapa de diseño', planes:0, fotos:[],
  ...
  { id:'terraza-kalah', name:'Terraza Kalah', type:'Residencial', location:'San Pedro, N.L.', year:'2026', client:'Privado', area:'50 m²', status:'Construido', planes:0,
    portada:'Kalah 1.png',
    fotos:['Kalah 1.png','Kalah 2.png'],
    tagline:'Cubierta de acero y deck de madera que amplían el penthouse hacia el exterior.',
    longDesc:'Expansión de terraza en el penthouse de una torre departamental, resuelta con una cubierta de acero y deck de madera.',
    longDesc2:'La idea parte de una necesidad concreta: generar un espacio de convivencia sombreado y ventilado, sin sacrificar las vistas que ofrece el departamento en altura.',
    longDesc3:'La estructura ligera de acero permite cubrir el área con el mínimo apoyo, mientras el deck de madera aporta calidez y define el nuevo espacio exterior como una extensión natural de la vivienda.' },
  ...
  { id:'oficinas-dileo', name:'Oficinas Dileo', type:'Corporativo', location:'Monterrey, N.L.', year:'2023', client:'Confidencial', area:'200 m²', status:'En etapa de diseño', planes:1,
    ...
    tagline:'Un área operativa que funciona, a la vez, como showroom de la marca.',
    longDesc:'Remodelación de un espacio institucional en el que el área operativa funge, a la vez, como showroom de los propios productos y servicios del cliente.',
    longDesc2:'El proyecto se resolvió como un espacio abierto y colaborativo, complementado con salas de juntas y espacios privados que atienden las necesidades y procesos internos de la operación diaria.' },
